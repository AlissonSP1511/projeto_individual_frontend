...
//cartaocredito
router.get('/cartaocredito', (req, res) => { CartaoCreditoController.getAll(req, res), console.log('get all router') })
...
router.get('/carteirainvestimento', (req, res) => { CarteiraInvestimentoController.getAll(req, res), console.log('get all router') })
...
//categoria
router.get('/categoria', (req, res) => { CategoriaController.getAll(req, res), console.log('get all router') })
...
//conta
router.get('/conta', (req, res) => { ContaController.getAll(req, res), console.log('get all router') })
...
//faturacartaocredito
router.get('/faturacartaocredito', (req, res) => { FaturaCartaoCreditoController.getAll(req, res), console.log('get all router') })
...
//investimento
router.get('/investimento', (req, res) => { InvestimentoController.getAll(req, res), console.log('get all router') })
...
router.get('/lancamentocartaocredito', (req, res) => { LancamentoCartaoCreditoController.getAll(req, res), console.log('get all router') })
...
//transacao
router.get('/transacao', (req, res) => { TransacaoController.getAll(req, res), console.log('get all router') })
...
//usuario
router.get('/usuario', (req, res) => { UsuarioController.getAll(req, res), console.log('get all router') })
